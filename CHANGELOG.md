...
- data/gitlab_group_service_account_access_tokens, resource/gitlab_group_service_account_access_token:  [Add description to gitlab_group_service_account_access_token](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/15668025495152c3886390e30a2c057f8072931e) by @nicolas.boussuge.fintech ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/3232))
- resource/gitlab_application_settings:  [Add `max_yaml_*` settings to `gitlab_application_settings` resource](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/b79989b8870e9068be3f380ce337213ead126274) by @mvandenburgh ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/3231))
- data/gitlab_project, data/gitlab_projects, resource/gitlab_project:  [Add mr_default_title_template to projects](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/4ff36248f586ac515392419443eda037a1123677) by @gkepas ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/3214))
- data/gitlab_project, data/gitlab_projects, resource/gitlab_project:  [Add reviewer_assignment_strategy to projects](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/2da2a82d98b534db2fd61f0a62e6f712a7adcf1b) by @gkepas ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/3213))
- resource/gitlab_group_integration_jira:  [Add group resource for jira issue integration](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/8264d5595979043a9f88644f805b0a76ac7ea6fe) by @jspagnola ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/3212))
- resource/gitlab_project_feature_flag, resource/gitlab_project_feature_flag_user_list:  [Add support for feature flags](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/ff6be514705c48f893194b363683c5e140607b05) by @rantoniuk ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/3209))
- resource/gitlab_project_service_account_access_token:  [Add project service account access token](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/1353eae08183d711a5cc6eb856194d2db5f2fac4) by @jspagnola ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/3208))
- data/gitlab_group, data/gitlab_groups, resource/gitlab_group:  [Adds crm to gitlab group](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/ff91f499d8305b707e615bf3da742efca1e23bed) by @jspagnola ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/3184))
- resource/gitlab_group_dependency_proxy_image_ttl_policy:  [Add group_dependency_proxy_image_ttl resource](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/3533b83f2dd4b4989b40a8d97c7e6e22b3e95bfd) by @gkepas ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/3180))
- resource/gitlab_compliance_requirement:  [Add new gitlab_compliance_requirement resource](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/1a01796ea3d56339a5d3d51c48859b4fb23f646f) by @mness ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/3178))
- resource/gitlab_project, resource/gitlab_project_security_settings:  [Add gitlab_project_security_settings resource](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/8080873399db019038bdfb2aae257e8ef0f56754) by @gkepas ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/3167))
- resource/gitlab_user:  [Add is_auditor flag to gitlab_user](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/f5139d25d86c465273d14b486f10bc29ff536481) by @gkepas ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/3163))

### BUG FIXES (7 changes)

- resource/gitlab_project:  [fix: handle panic when waiting for default branch protection](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/79e5fc8fa31ef096f0a37b2402f5047f82c72ef9) by @gkepas ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/3235))
- data/gitlab_group_service_account, data/gitlab_project_service_account, resource/gitlab_group_service_account, resource/gitlab_project_service_account:  [fix: read the service account email from the service accounts API](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/364b405dba696a91aa11ba4c7cc06bb8d73e237a) by @jspagnola ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/3234))
- resource/gitlab_group_service_account_access_token:  [Fall back to group-scoped revoke for group service account access token delete](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/22fb92c1656c86bbed403766c0925dd852877446) by @nicolas.boussuge.fintech ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/3223))
- [fix: prevent panic on nil Response in AugmentVariableClientError](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/dc59bec8a9e79dde100abf2f1f93c5163949681c) by @jeremad ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/3222))
- data/gitlab_group_provisioned_users:  [Fix pagination for gitlab_group_provisioned_users data source](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/33766638c5fff8cf0133a266a70744644e1de142) by @kunal261708 ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/3203))
- resource/gitlab_group_security_policy_attachment:  [Allow security policy attachments when creating group in same apply](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/9339a14485c880945d5a808a3506614547725f69) by @heidi.berry ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/3186))
- resource/gitlab_compliance_framework:  [Improve security on compliance framework resource by using Variables for GraphQL](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/0fa13982f8a490760f8381b7cee25bd8c00970d2) by @mness ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/3201))
...
- resource/gitlab_application_settings:  [Add secret_push_protection_available in gitlab_application_settings](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/18bd199e97c6f2a2fa7f40a0333ae859606a27c3) by @rizart_d ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/3142)) 
- resource/gitlab_saved_reply:  [Add gitlab_user_saved_reply, gitlab_group_saved_reply,...](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/6cc07f6816052cef9569a83de353753cbff4c870) by @jspagnola ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/3116)) 
- resource/gitlab_group_branch_protection:  [Add gitlab_group_branch_protection resource](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/86d18a42e7f099b6137e1f1e471b24e6cf3291ae) by @jspagnola ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/3085)) 
- resource/gitlab_project, datasource/gitlab_project, datasource/gitlab_projects:  [feat: Add ci_display_pipeline_variables parameter to gitlab_project](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/c4f48a86546237ee404c0ca6aa996a2f1986cf39) by @gatlavishweshwarreddy26 ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/3091)) 
- resource/gitlab_group_hook, resource/gitlab_project_hook:  [Add `url_variables` attribute to project_hook and group_hook to enable masking](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/c1d72914f11c26c5ae5d5501611e0a6bd395d604) by @mness ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/3069)) 
- data/gitlab_group_service_account, data/gitlab_instance_service_account, data/gitlab_project_service_account, resource/gitlab_group_service_account, resource/gitlab_instance_service_account, resource/gitlab_project_service_account:  [Add resource and data for project service account](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/3239dc99b9da757ca145d476cd6ddf0711311198) by @jspagnola ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/3099))

### IMPROVEMENTS (12 changes)

- resource/gitlab_project_integration_jira:  [Add support for Jira Service Accounts in project integration](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/34611c94fb71997dfda9b557dfc1fac6e684451a) by @heidi.berry ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/3139)) 
- resource/gitlab_group_service_account:  [Harden name updates in gitlab_group_service_account](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/bde3e196166d555cb230c23848159f16faa034a6) by @skarbek ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/3135)) 
- resource/gitlab_group_saml_link:  [Add security_manager access level support to gitlab_group_saml_link resource](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/56c6f830824d10549c4fac47a4e4a8a83ed80345) by @jspagnola ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/3140)) 
- resource/gitlab_project_hook:  [Add missing events on project/group hooks](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/836b710966b1f96e5cfee47615d69aba8f26b899) by @jspagnola ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/3136)) 
- resource/gitlab_system_hook:  [Implement Update, align hook schemas](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/a8db3a3c48ed9fb9c94cd80058db0545f492b42a) by @jspagnola ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/3125)) 
- resource/gitlab_group_hook:  [Add milestone_events and resource_access_token_events to gitlab_group_hook](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/7e4994416113b04c0e2d2d37ba70a9959f336b40) by @gatlavishweshwarreddy26 ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/3122)) 
- resource/gitlab_member_role:  [Add several new permissions to gitlab_member_role resource](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/9af40972a751c61841dba6a3afc2ee45c74d9169) by @gatlavishweshwarreddy26 ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/3121)) 
- data/gitlab_project:  [Add `active` to data projects and marked_for_deletion to data project](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/8d0daeb9d4ce61653ccbc386c38d21438db49150) by @jspagnola ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/3101)) 
- data/gitlab_group_hook, data/gitlab_group_hooks, data/gitlab_project_hook, data/gitlab_project_hooks, data/gitlab_system_hook, data/gitlab_system_hooks, resource/gitlab_group_hook, resource/gitlab_project_hook, resource/gitlab_system_hook:  [Add signing keys to project/group/system](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/b10557dd4295ecf6ae2a2f2f5b32f5cecd7cad2e) by @jspagnola ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/3093))
- data/gitlab_project, data/gitlab_projects, resource/gitlab_project:  [Align gitlab_project and gitlab_projects data source models](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/b3196fa0c4354bfbfb4fe31deaf582a07867f962) by @jspagnola ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/3108))
- data/gitlab_group, data/gitlab_groups:  [Align gitlab_group and gitlab_groups data source models](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/38b7d27bfc0bee066ca2e2d1dfa0b8dc014e11d6) by @jspagnola ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/3111))
- data/gitlab_group_label, data/gitlab_group_labels, data/gitlab_project_label, data/gitlab_project_labels, resource/gitlab_project_label:  [Add priority to project label](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/c2cdf4db4cc60b8001af715f31fa5e18cc2178d0) by @jspagnola ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/3130))

### BUG FIXES (7 changes)

- datasource/gitlab_group_subgroups:  [Fix non-functional attributes in datasource gitlab_group_subgroups](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/5a74d7881e9635a8c00e17d116e847815bccf2dc) by @heidi.berry ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/3131)) 
- resource/gitlab_group_service_account:  [fix: allow in-place update of skip_wait_for_deletion on group service account](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/876e5f293676e8f53ccda43b3f1763e958eced3c) by @patrickrice ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/3128)) 
- resource/gitlab_project, datasource/gitlab_project, datasource/gitlab_projects:  [Fix project pipeline cancellation value](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/f1a8452b27b584aa7e655b0f3382b4d5f8807787) by @lzoz ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/3068)) 
- resource/gitlab_project_job_token_scopes:  [Fix project job token scopes migration from 18.X -> 19.0+ releases](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/0aaea197443c44a0eaa20eeb2f8fb9f4764e84a0) by @jspagnola ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/3100)) 
- resource/gitlab_system_hook:  [fix: prevent nil pointer panic in gitlab_system_hook Create when token is not set](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/faa4851ec38d5a0570ad189603c9f5b2ee60b6c1) by @gatlavishweshwarreddy26 ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/3120))
- resource/gitlab_project_job_token_scopes:  [Avoid 400 when importing gitlab_project_job_token_scopes with enabled not set](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/d8293bb9af3a4c66ea3d2b66d794f384e9f8061f) by @heidi.berry ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/3107))
- resource/gitlab_group_deploy_token:  [Add state mover for gitlab_group_deploy_token](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/8947220481bfcc16b21e7106bd38c738c127da36) by @heidi.berry ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/3126))

## 19.0.0 (2026-05-21)

### BREAKING CHANGES (11 changes)

See the 19.0 upgrade guide for more information.

- datasource/gitlab_group_hook, datasource/gitlab_group_hooks, datasource/gitlab_project_hook, datasource/gitlab_project_hooks: [Remove always blank token attributes from data sources](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/1ba510ded205078d2b7de65b7e15dfd01e3dd56b) by @heidi.berry ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/3052))
- datasource/gitlab_project_protected_branch, datasource/gitlab_project_protected_branches, resource/gitlab_branch_protection: [Add access_level attribute to allowed_to_* properties](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/a4f31bf1fafd93d99641dab73e3fceb7b3e75cb1) by @mness ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/2920))
- resource/gitlab_deploy_token, resource/gitlab_project_mirror, resource/gitlab_runner, resource/gitlab_label: [Remove deprecated resources](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/cee7ae5c0fc9f9eafeea0c8e460fdf2f529ff7e3) by @heidi.berry ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/3051))
- resource/gitlab_integration_github, resource/gitlab_integration_microsoft_teams, resource/gitlab_integration_pipelines_email: [Remove old integration resources 4](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/52922ea90db2a72c4385206714860272aca84e4f) by @heidi.berry ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/3050))
- resource/gitlab_integration_emails_on_push, resource/gitlab_integration_redmine, resource/gitlab_integration_telegram: [Remove old integration resources 2](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/375100dde125dce5c382c506c0497731bc3f797f) by @heidi.berry ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/3048))
- resource/gitlab_integration_external_wiki, resource/gitlab_integration_jira, resource/gitlab_integration_mattermost: [Remove old integration resources 3](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/c64a581767e8f6d17b4f9c79ee43ff1624810ff0) by @heidi.berry ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/3049))
- resource/gitlab_integration_custom_issue_tracker, resource/gitlab_integration_harbor, resource/gitlab_integration_jenkins: [Remove old integration resources](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/c7437503e4516f18821642b4e34176737bd92b9c) by @heidi.berry ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/3047))
- resource/gitlab_project_job_token_scopes: [Remove gitlab_project_job_token_scopes.project_id](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/ba37dc5e6231397e2e3d8a11599a7518d68ac6b8) by @heidi.berry ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/3053))
- datasource/gitlab_projects:  [Migrate projects datasource](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/6cc63151741755bb878868db817affefca7ea6d3) by @heidi.berry ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/3073))
- datasource/gitlab_project, datasource/gitlab_project_membership, datasource/gitlab_repository_tree, resource/gitlab_project_protected_environment: [Remove deprecated attributes 2](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/57ab08651771895eef3fdbed4b7a54719fe05332) by @heidi.berry ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/3057))
- resource/gitlab_integration_slack, resource/gitlab_project, resource/gitlab_project_share_group, resource/gitlab_application_settings: [Remove deprecated attributes from various resources](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/523c6490833ab4ad6e8d8756e193bc278eb3d713) by @heidi.berry ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/3055))

### FEATURES (11 changes)

- resource/gitlab_project:  [Add support for `archive_on_destroy`](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/a1e38640f7ac8bfd6ad9d21f60a7ae4f52fb9524) by @jspagnola ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/3083))
- resource/gitlab_group_saml_link:  [add Support `minimal` access levels for `gitlab_group_saml_link`](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/79a4b10f5cb248bf8d9d869557efae8ebe5c53b6) by @ash-abdellatif ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/3087))
- resource/gitlab_project, datasource/gitlab_project, datasource/gitlab_projects:  [Add package_registry_access_level to gitlab_project resource and datasources](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/4e2fe508b6f2262f2210714aca5b6175aed1019a) by @aishahsofea ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/3074))
- resource/gitlab_group_service_account:  [Add skip_wait_for_deletion attribute to gitlab_group_service_account](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/915da218638ffd01fcf7732119ca92b660bb77f7) by @PatrickRice ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/3079))
- resource/gitlab_group_integration_harbor:  [feat: Add gitlab_group_integration_harbor resource](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/9317e046e5ee2f0850aa0d9ef6c414a8ac2f1cac) by @HamzaHassanain ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/2881))
- resource/gitlab_project_integration_datadog:  [Implement project Datadog integration](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/76059aa7c99a3d8cb31175023c2e54d2edbd6c5e) by @aishahsofea ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/3036))
- resource/gitlab_application_settings: [Add session_expire_from_init on gitlab_application_settings](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/495422b00a5e3f57cb825d0810f9d938073e7164) by @ric.gato ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/3039))
- resource/gitlab_application_settings: [Add pages_unique_domain_default_enabled to gitlab_application_settings](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/6bdb5e19a5b561f2ad0609ad13177e5e02863269) by @aishahsofea ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/3072))
- resource/gitlab_project_push_mirror: [Add host_keys for push_mirror.](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/835b0105bac4eb5c5fd38f12fd6f71e388177c61) by @jspagnola ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/3023))
- resource/gitlab_project_integration_google_chat: [Add gitlab_project_integration_google_chat resource](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/53de71a791353259df636064818a2fd37f37b577) by @mohamedmongy96 ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/2945))
- resource/gitlab_application_settings: [Support disable_password_authentication_for_users_with_sso_identities](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/e560576ea8b10729a4f2ca4d6ae342edac914007) by @loelu ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/3082))

### IMPROVEMENTS (1 changes)

- [Fix typos in documentation](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/ca39e4579427dc787068f2a4ce6dd5989bf852bd) by @hhubert14 ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/3066))

### BUG FIXES (5 changes)

- data/gitlab_projects:  [Fix defaults in datasource gitlab_projects](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/dbcdb526ec6cb665295d5e5e04da7a30b99da7c7) by @heidi.berry ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/3095))
- resource/gitlab_application_settings: [Fix bug where ci_job_live_trace_enabled setting has no effect](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/6c4198414eb467ddac7d217690f9b4371098f304) by @heidi.berry ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/3056))
- resource/gitlab_user_runner: [Amend gitlab_user_runner to save first group_id in API response](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/21f0ae4a544bb99737d92bdcfa882ee35b2cfd44) by @heidi.berry ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/3028))
- resource/gitlab_project_level_mr_approvals: [Project MR Approvals, deprecate require_password_to_approve, add replacement](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/593d3e9d699cb01a10d75aed87b31cf2faca68b3) by @heidi.berry ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/3042))
- resource/gitlab_project_hook: [Fix: `gitlab_project_hook` update fails when computed identity attributes are unknown in plan](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/890fd66298f1ef080a80b2ed407136b7e807853c) by @fatmcgav ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/3067))
...
- datasource/gitlab_project_label, datasource/gitlab_project_labels:  [Gitlab project label/labels datasource implementation](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/73c1b8219f2dc96fd0d368b1bde6b7c77dc503eb) by @bastian82 ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/2890))
- resource/gitlab_application_settings:  [Add notify_on_unknown_sign_in in Application Settings](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/15675826d1aa5589e9ace5972314da36bc5abcdd) by @12bodickyn ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/2928))
- resource/gitlab_group_integration_mattermost:  [Add gitlab_group_integration_mattermost resource](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/85e2c3a5377657536ac35ce10791d4c237fb58d7) by @HamzaHassanain ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/2909))
- resource/gitlab_project_hook, datasource/gitlab_project_hook, datasource/gitlab_project_hooks:  [Add emoji_events support to gitlab_project_hook resource](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/8568dbd04e316fb1cc10fd1bd1baa7d01b002c3a) by @yugannkt ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/2902))
- resource/gitlab_project, resource/gitlab_group:  [Add max_artifacts_size attribute to group and project resources](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/fb8b39f98e8f8049d09d2466fc849a3de36cb98c) by @mness ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/2883))

### IMPROVEMENTS (10 changes)

- resource/gitlab_project_integration_github:  [refactor: migrate github integration to framework](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/e2897f502ea89dffcd678a4e7d612e8512dbd4f1) by @heidi.berry ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/2936))
- [Fix `make testacc-up`](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/4df1a31f55d73b9682d3f47fd13702903d60c2db) by @SinaMoghaddas ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/2911))
- resource/gitlab_group_ldap_link:  [Improve error message when gitlab_group_ldap_link.id is invalid](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/054a186ca3ec4232667bb1439de5d6d92016db9f) by @heidi.berry ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/2914))
- data/gitlab_project_branches:  [Add regex/search filters](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/fa0ae4f3ff3ac6e07975c1584da5d933d8e00e41) by @SinaMoghaddas ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/2780))
- resource/gitlab_project:  [Deprecate old `gitlab_project` mirror fields](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/6c9e08e7c9577e52bcd56b3bc49113a224fa4089) by @heidi.berry ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/2906))
- [Fix grammar in resource descriptions](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/5231d8844491d7325679cc786dcf35847946380b) by @heidi.berry ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/2905))
- resource/gitlab_tag_protection:  [Add deploy_key_id support to gitlab_tag_protection resource](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/ef81cd2f5141162463c0f0be23cff9a0d069d1b6) by @yugannkt ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/2900))
- resource/gitlab_project_milestone:  [refactor: migrate gitlab_project_milestone to Framework](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/10ee006128a0f3ed5c3bbc9d2bd3c72c427d0f4c) by @heidi.berry ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/2880))
- [Update 19.0 Migration guide for state move info](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/ffdf35843d7b7d2da18e974d0730699fe3fdb147) by @heidi.berry ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/2893))
- resource/gitlab_project_integration_external_wiki:  [refactor: migrate external_wiki to framework](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/b9eb1d2889fcbd8cc11ca24c8c2ff452eaee455d) by @heidi.berry ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/2878))

### BUG FIXES (2 changes)

- resource/gitlab_deploy_token, resource/gitlab_project_deploy_token:  [Add support to `gitlab_project_deploy_token` for cross-resource state move actions](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/67c654503eeb2351ddc00a4e61db01fe1b8d3a21) by @PatrickRice ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/2892))
- resource/gitlab_project_deploy_token:  [Gracefully delete project deploy token if project was moved](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/e55ac48b440ba283dbffbe4ce642eaf5a1463447) by @timofurrer ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/2885))
- resource/gitlab_release:  [Fix ability to create releases with milestones](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/5695232cc088f706d75200953df769e21be094fa) by @heidi.berry ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/2939))
...
- Bumped GitLab client-go dependency to v0.148.0 to improve default retry policy ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/2677))
