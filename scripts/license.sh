...
[[ -n $encrypted_4a4b21de8599_key ]] && openssl aes-256-cbc -K $encrypted_4a4b21de8599_key -iv $encrypted_4a4b21de8599_iv -in ${_license_file}.enc -out "${_license_dir}/${_license_file}" -d
