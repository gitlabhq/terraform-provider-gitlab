...
- `max_yaml_depth` (Number) The maximum depth of nested CI/CD configuration added with the `include` keyword.
- `max_yaml_size_bytes` (Number) The maximum size in bytes of a single CI/CD configuration file.
